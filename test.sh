...
(
nohup python -u test.py --dataset smartshaped --data_path ./dataset/mvisa/data \
--checkpoint_path ./my_exps/train_mvtec/epoch_post_24_2.pth \
--save_path ./results/test_mvtec_container --pretrained_path ./pretrained_weight/ViT-L-14-336px.pt \
...
) > ./log_test_mvtec_container.out 2>&1 &
