...
--checkpoint_path ./my_exps/train_visa/epoch_post_22_2.pth \
--save_path ./results/test_visa_container --pretrained_path ./pretrained_weight/ViT-L-14-336px.pt \
...
) > ./log_test_visa_container.out 2>&1 &
